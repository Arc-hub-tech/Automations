...
================================================================
 ...
 2. Open an elevated PowerShell prompt (Run as Administrator) on the
    ...
    to the logs under C:\ArcLogs\GoldImagePrep, then runs it:
       ...
       $p="$env:SystemDrive\ArcLogs\GoldImagePrep\Prep-WS2025-RDSH-Template.ps1"; md (Split-Path $p) -Force|Out-Null; irm https://raw.githubusercontent.com/Arc-hub-tech/Automations/main/gold-image/Prep-WS2025-RDSH-Template.ps1 -OutFile $p; Set-ExecutionPolicy Bypass -Scope Process -Force; & $p
